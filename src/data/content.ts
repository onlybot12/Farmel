...
export const clients = [
  'Richeese Factory', 'Waskita Karya', 'Bali Hai', 'PP Konstruksi',
  'Argha Karya', 'Hutama Karya', 'Unifam', 'Wika',
  'Kiko', 'Angkasa Pura II', 'Darya Varia', 'Adhi Karya',
  'Sierad Produce', 'Nabati',
]
